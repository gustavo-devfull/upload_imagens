#!/usr/bin/env python3
"""
🚀 SISTEMA FLASK SUPER SIMPLES
Sistema Flask com frontend super simplificado para garantir funcionamento
"""
...
@app.route('/')
def serve_frontend():
    """Serve o frontend HTML super simples"""
    try:
        html_content = get_super_simple_frontend_html()
        return html_content
    except Exception as e:
        logger.error(f"Erro ao servir frontend: {e}")
        return jsonify({'error': f'Erro interno: {e}'}), 500

def get_super_simple_frontend_html():
    """Retorna o HTML do frontend super simples"""
    return '''
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <title>🚀 Sistema Excel - Super Simples</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🚀 Sistema Excel - Super Simples</h1>
        ...
        try:
            ...
            if DETECTOR_INTEGRADO_AVAILABLE:
                ...
                if len(images) == 0:
                    ...
                    refs = [img['ref'] for img in images]
                    debug_info.append(f"📊 REFs encontradas: {', '.join(refs)}")
...
if __name__ == '__main__':
    port = int(os.getenv('PORT', 8085))  # Porta diferente para evitar conflito
    debug = os.getenv('FLASK_ENV') != 'production'

    print("🚀 SISTEMA FLASK SUPER SIMPLES")
    print("=" * 50)
