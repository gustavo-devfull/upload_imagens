#!/usr/bin/env python3
"""
Sistema de Upload de Imagens Excel - Versão Multi-Porta SSH/FTP
Versão com múltiplas portas SSH e FTP como fallback
"""
...
# Configurações SSH - Múltiplas portas
SSH_CONFIGS = [
    ...
    {"host": "46.202.90.62", "port": 2222, "user": "u715606397", "key": "/home/moribrasil/.ssh/id_ed25519", "pass": "]X9CC>t~ihWhdzNq"},
    {"host": "46.202.90.62", "port": 8022, "user": "u715606397", "key": "/home/moribrasil/.ssh/id_ed25519", "pass": "]X9CC>t~ihWhdzNq"},
]

# Configurações FTP (fallback)
FTP_CONFIGS = [
...
<head>
    ...
    <title>🚀 Sistema Upload Excel - Multi-Porta</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Versão Multi-Porta SSH/FTP - Conectividade Máxima</p>
        </div>
        ...
        <div class="info">
            ...
            <p><strong>Dependências:</strong> Flask ✅ | openpyxl ✅ | SSH ✅ | FTP ✅</p>
        ...
        <div class="method-selector">
            ...
            <div class="method-option">
                ...
                <label for="auto">Automático (Recomendado) - Testa SSH primeiro, depois FTP</label>
            </div>
            <div class="method-option">
                <input type="radio" id="ssh" name="method" value="ssh">
                <label for="ssh">SSH (Múltiplas portas)</label>
            </div>
            <div class="method-option">
                <input type="radio" id="ftp" name="method" value="ftp">
                <label for="ftp">FTP (Fallback)</label>
            </div>
        </div>
        ...
        <div class="steps" id="steps" style="display: none;">
            ...
            <div class="step" id="step3">🔌 Testando Conexões</div>
...
def test_ssh_connections():
    """Testa conectividade SSH com múltiplas portas"""
...
def test_ftp_connections():
    ...
    for config in FTP_CONFIGS:
        try:
            debug_info = []
            debug_info.append(f"🔌 Testando FTP: {config['host']}:{config['port']}")
            ...
            debug_info.append(f"✅ FTP funcionando")
            config['debug'] = debug_info
            return config, debug_info
...
def create_app():
    ...
    def index():
        ...
        if ssh_config:
            recommended_method = "SSH"
            working_config = ssh_config
        elif ftp_config:
            recommended_method = "FTP"
    ...
    def health():
        ...
        try:
            ...
            health_data = {
                "status": "ok",
                "message": "Sistema Multi-Porta SSH/FTP funcionando",
                "timestamp": time.time(),
...
def upload_auto(images, debug_info):
    """Upload automático - SSH primeiro, FTP como fallback"""
    debug_info.append("🔄 Modo automático: testando SSH primeiro")
    ...
    # Se SSH falhar, tenta FTP
    debug_info.append("⚠️ SSH falhou, tentando FTP")
    ftp_config, ftp_debug = test_ftp_connections()
    if ftp_config:
    ...
    # Se ambos falharem
    debug_info.append("❌ SSH e FTP falharam")
    return 0, len(images)
...
if __name__ == "__main__":
    ...
    logger.info("🚀 Iniciando Sistema Multi-Porta SSH/FTP...")
    print("🚀 Iniciando Sistema Multi-Porta SSH/FTP...")
