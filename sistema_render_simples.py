#!/usr/bin/env python3
"""
Sistema de Upload de Imagens Excel - Versão Render Simples
Versão simplificada e robusta para Render.com
"""
...
if __name__ == "__main__":
    ...
    logger.info("🚀 Iniciando Sistema Render...")
