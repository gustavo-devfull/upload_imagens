#!/usr/bin/env python3
"""
Sistema de Upload de Imagens Excel - Versão Railway Simples
...
def create_flask_app():
    ...
    def upload():
        ...
        try:
            ...
            # Processamento
            stats = process_excel_simple(temp_path, debug_info)
...
def process_excel_simple(file_path, debug_info):
    """Processamento simples do Excel"""
    try:
