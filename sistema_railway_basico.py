#!/usr/bin/env python3
"""
Sistema de Upload de Imagens Excel - Versão Railway Básica
Versão mínima para Railway com health check com delay
"""
...
<head>
    ...
    <title>🚀 Sistema Upload Excel - Railway</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Versão Railway - Upload de Imagens Automático</p>
        </div>
...
# Variável global para controlar quando o servidor está pronto
SERVER_READY = False
...
def create_app():
    ...
    @app.route('/health')
    def health():
        """Health check com delay para Railway"""
        global SERVER_READY
        
        try:
            # Aguarda 10 segundos antes de considerar o servidor pronto
            if time.time() - START_TIME < 10:
                logger.info("⏳ Servidor ainda inicializando...")
                return jsonify({
                    "status": "starting",
                    "message": "Servidor inicializando...",
                    "timestamp": time.time(),
                    "uptime": time.time() - START_TIME
                }), 202  # Accepted - ainda inicializando
            
            # Marca servidor como pronto após 10 segundos
            if not SERVER_READY:
                SERVER_READY = True
                logger.info("✅ Servidor marcado como pronto")
            
            # Verifica se o servidor está funcionando
            health_data = {
                "status": "ok",
                "message": "Sistema Railway funcionando",
                "timestamp": time.time(),
                "uptime": time.time() - START_TIME,
                "dependencies": {
                    "ftp": FTP_AVAILABLE,
...
def main():
    ...
    print("🚀 Iniciando Sistema Railway...")
