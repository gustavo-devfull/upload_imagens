#!/usr/bin/env python3
"""
Sistema de Upload de Imagens Excel - Versão Flask para Render
...
<head>
    ...
    <title>🚀 Sistema Upload Excel - Render Flask</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Versão Flask para Render - Upload de Imagens Automático</p>
        </div>
        ...
        <div class="footer">
            <p>🔧 Sistema Flask para Render | 🚀 Upload Automático | 📊 Detecção Inteligente</p>
        </div>
    </div>
...
def create_flask_app():
    ...
    def health():
        return jsonify({
            "status": "ok",
            "message": "Sistema Flask para Render funcionando",
            "dependencies": {
                "ftp": FTP_AVAILABLE,
    ...
    def upload():
        try:
            ...
            stats = process_excel_flask(temp_path)
...
def process_excel_flask(file_path):
    """Processamento completo do Excel para Flask"""
    try:
        workbook = openpyxl.load_workbook(file_path)
        worksheet = workbook.active
        
        # Processa REFs
        refs = get_ref_column_data(worksheet, start_row=4)
        
        # Processa imagens
        images = extract_images_from_worksheet(worksheet, start_row=4, photo_column='H')
        ...
        return {
            ...
            'errors': errors,
            'message': 'Processamento Flask concluído com detecção de imagens'
        }
...
def get_ref_column_data(worksheet, start_row=4):
...
def extract_images_from_worksheet(worksheet, start_row=4, photo_column='H'):
...
def start_flask_server():
    ...
    print("🚀 Iniciando Sistema Flask para Render...")
    print("=" * 50)
