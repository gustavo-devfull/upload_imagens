#!/usr/bin/env python3
"""
Sistema de Upload de Imagens Excel - Versão Render com FTPLib
Versão otimizada para Render.com usando ftplib como método principal
"""
...
# Configurações FTP - PRIORITÁRIO para Render
FTP_CONFIGS = [
...
SSH_CONFIGS = [
    {"host": "46.202.90.62", "port": 65002, "user": "u715606397", "key": None, "pass": "]X9CC>t~ihWhdzNq"},
    {"host": "46.202.90.62", "port": 22, "user": "u715606397", "key": None, "pass": "]X9CC>t~ihWhdzNq"},
]
...
<head>
    ...
    <title>🚀 Sistema Upload Excel - Render FTPLib</title>
    <style>
        ...
        .render-info { background: #e3f2fd; border: 1px solid #2196f3; color: #1565c0; padding: 10px; border-radius: 5px; margin: 10px 0; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Versão Render.com com FTPLib Prioritário</p>
        </div>
        ...
        <div class="render-info">
            <h3>🚀 Estratégia Render FTPLib</h3>
            <p><strong>1º Prioridade:</strong> FTP com ftplib (otimizado para Render)</p>
            <p><strong>2º Fallback:</strong> SSH apenas se FTP falhar</p>
            <p><strong>Vantagem:</strong> Melhor performance na nuvem Render</p>
        </div>
        ...
        <div class="method-selector">
            ...
            <div class="method-option">
                ...
                <label for="ftp">FTP (ftplib) - Otimizado para Render</label>
            </div>
            <div class="method-option">
        ...
        try:
            ...
            if result == 0:
                ...
                try:
                    ...
                    # No Render, usa apenas senha (sem chaves SSH)
                    debug_info.append(f"🔑 Autenticando com senha")
...
def create_app():
    ...
    def health():
        ...
        try:
            ...
            health_data = {
                "status": "ok",
                "message": "Sistema Render FTPLib funcionando",
                "timestamp": time.time(),
                "platform": "Render.com",
                "python_version": f"{sys.version_info.major}.{sys.version_info.minor}.{sys.version_info.micro}",
    ...
    def upload():
        ...
        try:
            ...
            # Salva arquivo temporariamente (Render usa /tmp)
...
if __name__ == "__main__":
    ...
    logger.info("🚀 Iniciando Sistema Render FTPLib...")
    print("🚀 Iniciando Sistema Render FTPLib...")
